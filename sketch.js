...
function preload(){
  Sun = loadImage("suntransparent.png");
...
function draw() {
  ...
  p1.debug=true;
  p1.setCollider("circle",0,0,75);
  p2.debug=true;
  p2.setCollider("circle",0,0,80);
  p3.debug=true;
  p3.setCollider("circle",0,0,80);
  p4.debug=true;
  p4.setCollider("circle",0,0,75);
  p5.debug=true;
  p5.setCollider("circle",0,0,75);
  p6.debug=true;
  p6.setCollider("circle",0,0,85);
  p7.debug=true;
  p7.setCollider("circle",0,0,75);
  p8.debug=true;
  p8.setCollider("circle",0,0,75);

  angle=angle+1;
  sun.rotation=60-angle;
  p1.rotation=60-angle;
  p2.rotation=60-angle;
  p3.rotation=60-angle;
  p4.rotation=60-angle;
  p5.rotation=60-angle;
  p6.rotation=60-angle;
  p7.rotation=60-angle;
  p8.rotation=60-angle;
